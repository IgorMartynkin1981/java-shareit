...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findBookings(long userId, String stateParam, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> findBookingsByOwner(long userId, String stateParam, Integer from, Integer size) {
        BookingState state = BookingState.from(stateParam)
                .orElseThrow(() -> new IllegalArgumentException("Unknown state: " + stateParam));
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
